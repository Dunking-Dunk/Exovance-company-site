export const services = [
    ...
    {
        title: "AI CONSULTING",
        description: "At Exovance, we provide expert AI consulting and strategic management to help businesses harness the full potential of artificial intelligence. From roadmap development to implementation, we craft tailored AI strategies that drive innovation, enhance efficiency, and ensure seamless integration for long-term success."
    }
];
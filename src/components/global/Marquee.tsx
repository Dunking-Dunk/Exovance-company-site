...
const ROW1 = ['CAMPUS SCHEDULE', 'CAMPUS INTELLIGENCE', 'AIVA VOICE AGENTS', 'BUILT FOR INDIA', 'AGENTIC AI', '30 SECONDS', 'CAMPUS SCHEDULE', 'CAMPUS INTELLIGENCE', 'AIVA VOICE AGENTS', 'BUILT FOR INDIA', 'AGENTIC AI', '30 SECONDS'];
const ROW2 = ['CAMPUS SCHEDULE', 'CAMPUS INTELLIGENCE', 'AIVA VOICE AGENTS', 'BUILT FOR INDIA', 'AGENTIC AI', '30 SECONDS', 'CAMPUS SCHEDULE', 'CAMPUS INTELLIGENCE', 'AIVA VOICE AGENTS', 'BUILT FOR INDIA', 'AGENTIC AI', '30 SECONDS'];

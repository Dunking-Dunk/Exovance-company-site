...
uniform float colorNum;      // number of quantization levels
uniform float pixelSize;     // virtual pixel size for dithering
...
void main() {
  ...
  // --- Ordered dithering (Bayer 8x8) scoped to this fragment only ---
  if (colorNum > 1.0) {

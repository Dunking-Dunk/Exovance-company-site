...
const ContactSection = () => {
    return (
        <section className="relative w-full py-28 md:py-40 lg:py-48 px-4 md:px-8 lg:px-32 min-h-[70vh] md:min-h-[80vh]">
            <div className="w-full">
                ...
                <motion.h2
                    ...
                    className="text-3xl md:text-5xl lg:text-6xl font-light tracking-widest text-white mb-6"
                >
                ...
                <motion.p
                    ...
                    className="max-w-5xl text-customGrayLight leading-relaxed text-base md:text-lg mb-10"
                >
                ...
                <div className="mt-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 text-customGrayLight/90">
                    <div className="rounded-xl border border-white/10 bg-white/5 p-5">
                        ...
                        <p className="text-sm leading-relaxed">From idea to MVP. Rapid prototyping, hardware-software integration, and proof-of-concepts.</p>
                    </div>
                    <div className="rounded-xl border border-white/10 bg-white/5 p-5">
                        <h4 className="text-white/90 text-lg mb-2">Automation & Optimization</h4>
                        <p className="text-sm leading-relaxed">Workflow automation, robotics control, and process optimization tailored to your operations.</p>
                    </div>
                    <div className="rounded-xl border border-white/10 bg-white/5 p-5">
                        <h4 className="text-white/90 text-lg mb-2">Advisory & Collaboration</h4>
                        <p className="text-sm leading-relaxed">Exploratory sessions to align on goals, de-risk delivery, and choose the right tech strategy.</p>
                    </div>
                </div>
